---
layout: model
title: SentencePolarityAsymmetry
model-status: code
model-category: Reasoning about Reasoning
model-tags: language, pragmatics, sentence-polarity
model-language: webppl
model-language-version: v0.9.7
---

This is a model of the production of affirmative and negative uttearnces, based on the vanilla model of Frank & Goodman 2012, but equipped with a relaxed semantics. It is described further in [Degen et al (under review)](https://arxiv.org/abs/1903.08237). 
